...
use level3::{TipPool, TIP_POOL_LEN, TipInstruction};
...
fn hack(env: &mut LocalEnvironment, challenge: &Challenge) {
    ...
    let seed: u8 = 1;
    let fee = amount as f64;
    let fee_recipient = challenge.vault_address;
    ...
    env.execute_as_transaction(
        &[Instruction {
            ...
            accounts: vec![
                ...
                AccountMeta::new(hacker_vault_address, false),
